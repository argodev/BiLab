...
public class AppletPostscriptPopup extends PostscriptPopup {
  ...
  public AppletPostscriptPopup(Frame parent, String title,OutputGenerator og) {
  ...
  public boolean handleEvent (Event e) {
	...
	og.getPostscriptProperties().height = 730;
      ...
      StringBuffer sb = og.getPostscript();
       SendFileCGI sf= new SendFileCGI("circinus.ebi.ac.uk",6543,"cgi-bin/sendfile","/ebi/barton/delly/michele/htdocs/temp/out.ps",System.out,sb.toString());

       sf.run();
       try {
	 URL fileski = new URL("http://circinus.ebi.ac.uk:6543/temp/out.ps");
	 if (parent instanceof AlignFrame) {
	   if (((AlignFrame)parent).parent instanceof Applet) {
