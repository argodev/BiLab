 ...
 *
 * $Header: /cvsroot/pathsoft/artemis/uk/ac/sanger/artemis/io/LocationParseException.java,v 1.1 2004/06/09 09:49:51 tjc Exp $
 */
...
public class LocationParseException extends ReadFormatException {
   ...
   **/
  public LocationParseException (String message, TokenEnumeration _enum) {
    super("Parse error at this point: " + _enum.toString () +
          ": " + message);
  }
