...
/**
 * type/CodonTranslationHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class CodonTranslationHelper {
    ...
    public static type.CodonTranslation read(
        ...
        final type.CodonTranslation value = new type.CodonTranslation();
            ...
            synchronized (org.omg.CORBA.TypeCode.class) {
                if (__typeCode == null) {
                    ...
                    _tcOf_members0 = org.omg.CORBA.ORB.init().create_string_tc(
                            0);
                    _members0[0] = new org.omg.CORBA.StructMember("codon",
                            _tcOf_members0, null);
                    _tcOf_members0 = type.AminoAcidHelper.type();
                    _members0[1] = new org.omg.CORBA.StructMember("amino_acid",
                            _tcOf_members0, null);
                    __typeCode = org.omg.CORBA.ORB.init().create_struct_tc(
                            type.CodonTranslationHelper.id(),
                            "CodonTranslation", _members0);
                    __active = false;
                }
            }
        }
