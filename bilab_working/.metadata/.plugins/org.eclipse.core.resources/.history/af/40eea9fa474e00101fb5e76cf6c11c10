...
public class BilabActionBarAdvisor extends ActionBarAdvisor {
    ...
    public BilabActionBarAdvisor(final IActionBarConfigurer configurer) {
        super(configurer);
    }

    private void addPerspectiveActions(final MenuManager menu) {
        final String openText = "OpenPerspective";
        final MenuManager changePerspMenuMgr = new MenuManager(openText,
        ...
        final MenuManager showViewMenuMgr = new MenuManager("Show View",
                "showView");
        final IContributionItem showViewMenu = ContributionItemFactory.VIEWS_SHORTLIST
                .create(getWindow());
    ...
    private void addSeparatorOrGroupMarker(final MenuManager menu,
        ...
        final boolean addExtraSeparators = BilabPlugin.getDefault()
    ...
    private MenuManager createEditMenu() {
        final MenuManager menu = new MenuManager("&Edit",
    ...
    private MenuManager createFileMenu() {
        final MenuManager menu = new MenuManager("&File",
    ...
    private MenuManager createHelpMenu() {
        final MenuManager menu = new MenuManager("&Help",
    ...
    private MenuManager createWindowMenu() {
        ...
        final IWorkbenchAction action = ActionFactory.OPEN_NEW_WINDOW
                .create(getWindow());
    ...
    protected void fillCoolBar(final ICoolBarManager coolBar) {
        ...
        { // File Group
            final IToolBarManager fileToolBar = new ToolBarManager(
                    coolBar.getStyle());
        ...
        { // Navigate group
            final IToolBarManager navToolBar = new ToolBarManager(
                    coolBar.getStyle());
